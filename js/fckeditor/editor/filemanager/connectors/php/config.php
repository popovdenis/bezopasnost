...
$dir = dirname(dirname(dirname(dirname(dirname(dirname(dirname(dirname(__FILE__))))))));
$dir = $dir.'/public_html/files';
/*if(!file_exists($dir)){
	mkdir($dir, 0755);
}*/
$Config['UserFilesPath'] = 'http://'. $_SERVER['SERVER_NAME'] .'/files';
