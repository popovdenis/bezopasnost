        ...
        <div id="item_block_<?= $item->item_id ?>" style="margin:5px 0 5px 0; float:left;">
            ...
            <span class="spn_mode">
                <img style="width:25px;height:25px;cursor:pointer;"
                     title="<?= $item->item_mode ?>" src="<?= base_url() ?>images/icons/<?= $item->item_mode ?>.png"/>
            </span>
...
<div style="float:left;">
    <div style="width:255px;float:left;">&nbsp;
        <img style="float:right;display:none;position:relative;top:21px;" id="paginate_img" src="<?= base_url() ?>images/add-note-loader.gif"/>
    </div>
