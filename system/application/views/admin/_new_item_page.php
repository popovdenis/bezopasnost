...
<div style="float:left;margin-bottom:25px;width:995px;">
    <div
        style="border-left:1px solid #CCCCCC;float:left;padding-left:10px;padding-top:10px;width:720px;padding:10px 0 10px 10px;">
        <div>
            ...
            <div>
                ...
                <textarea name="new_post_preview" id="new_post_preview" style="min-height:70px;width:715px;">
                    &nbsp;</textarea>
            </div>
            <?php if ($item_type == 'products') { ?>
                <div class="product_element">
                    <span><strong>Характеристики</strong></span><br/>
                    <textarea name="new_item_charecters" id="new_item_charecters"
                              style="min-height:70px;width:775px;"></textarea>
                </div>
            <?php } ?>
            <div>
            ...
            <div style="margin:10px 0 10px 0;">
                <div class="seo_params_block">
                    ...
                    <div class="seo_keywords">
                        ...
                        <input type="text" id="item_seo_keywords" name="item_seo_keywords" value=""
                               style="width:500px;"/>
                    </div>
    ...
    <div
        style="float: right; margin-right: 5px; overflow-y: auto; height: 570px; overflow-x: hidden; width: 235px;padding-right:15px;padding-top:10px;">
        <div>
