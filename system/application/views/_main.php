		...
		<div>
			<div class="text">
	            ...
	            <div class="categories">
	                <a href="<?php if(!empty($links_cat['doors'])) { echo base_url().'products/category/'.$links_cat['doors'][0]->category_id; } ?>"><img src="<?=base_url()?>images/categories/doors.png"/></a>
	                ...
	                <a href="<?php if(!empty($links_cat['skd'])) { echo base_url().'products/category/'.$links_cat['skd'][0]->category_id; } ?>"><img src="<?=base_url()?>images/categories/skd.png"/></a>
	                <a href="<?php if(!empty($links_cat['cylinders'])) { echo base_url().'products/category/'.$links_cat['cylinders'][0]->category_id; } ?>"><img src="<?=base_url()?>images/categories/cylinders.png"/></a>
	                <a href="<?php if(!empty($links_cat['other'])) { echo base_url().'products/category/'.$links_cat['other'][0]->category_id; } ?>"><img src="<?=base_url()?>images/categories/misc.png"/></a>
	            </div>
			</div>
