...
jQuery().ready(function(){
	...
	<div class="content">
		...
		<div class="infocontent" style="position:relative;float:left;">
			...
			<div style="float:left;width:590px;background:#EFEFEF none repeat scroll 0 0;font-size:12px;margin-top:10px;padding:14px 20px;">
				<div style="float:left;">Около <span id="count_result"><?=$search_result['count']?></span> результов найдено для &quot;<?=$keywords?>&quot;</div>
				<div style="float:right;">
					<form id="searchform" name="searchform" method="POST" action="<?=base_url()?>search" enctype="multipart/form-data">
                        ...
                        <img src="<?=base_url()?>images/search.png" class="search_lens" onclick="javascript: jQuery( '#searchform' ).submit();">
                    </form>
				</div>
			</div>
