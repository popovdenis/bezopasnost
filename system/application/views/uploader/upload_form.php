...
<script type="text/javascript" src="<?=base_url()?>js/uploader/swfuploader/js/swfupload.js"></script>
<script type="text/javascript" src="<?=base_url()?>js/uploader/swfuploader/js/swfupload.graceful_degradation.js"></script>
<script type="text/javascript" src="<?=base_url()?>js/uploader/swfuploader/js/handlers.js"></script>
<script type="text/javascript">
    ...
    window.onload = function () {
        swf_upload_control = new SWFUpload({
			// Backend settings
			upload_url: "<?=$upload_url?>",	// formsdemo/upload.php. Relative to the SWF file, you can use an absolute URL as well.
			...
			// Flash Settings
			flash_url : "<?=base_url()?>js/uploader/swfuploader/js/swfupload_f9.swf",	// Relative to this file
					...
					<tr>
						...
						<td>
							...
							<div id="degradedUI">
								...
								<input type="file" name="<?=$input_filename?>" id="<?=$input_filename?>" /> (10 MB max)<br/>
