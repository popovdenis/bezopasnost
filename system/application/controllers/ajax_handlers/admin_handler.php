...
class Admin_handler extends Controller
{
    ...
    function ajax_actions( )
    {
        ...
        switch ( $action )
        {
            ...
            case "filter_items_category":
                $data = $this->_items_block( $this->input->post( 'item_type' ), false, $this->input->post( 'item_category' ) );
            ...
            case "add_category":
                ...
                $category_data = array( 'category_title' => $category_title, 'category_desc' => '', 'category_date_added' => date( "Y-m-d H:i:s" ), 'category_parent' => $category_parent );
                $category_id = $this->category->set_category( $category_data );

                if ( !$item_id )
                {
                    $content = $this->_get_category_page( $category_id );
                    $data = (Object)array( 'header' => $content['header'], 'content' => $content['content'], 'category_id' => $category_id );
            ...
            case "update_category":
                ...
                $category_data = array( 'category_title' => $category_title, 'category_desc' => $category_desc, 'category_parent' => $category_parent );
            ...
            case "update_contacts":
                ...
                $contacts_data_time = array( 0 => array( 'time_from_h' => empty( $contact_time_1_f_h ) ? ''
                        ...
                        : $contact_time_1_f_m, 'time_to_h' => empty( $contact_time_1_t_h ) ? ''
                        : $contact_time_1_t_h, 'time_to_m' => empty( $contact_time_1_t_m ) ? ''
                        : $contact_time_1_t_m, 'time_tm_from_h' => empty( $contact_time_1_tm_f_h ) ? ''
                        : $contact_time_1_tm_f_h, 'time_tm_from_m' => empty( $contact_time_1_tm_f_m ) ? ''
                        : $contact_time_1_tm_f_m, 'time_tm_to_h' => empty( $contact_time_1_tm_t_h ) ? ''
                        : $contact_time_1_tm_t_h, 'time_tm_to_m' => empty( $contact_time_1_tm_t_m ) ? ''
                        : $contact_time_1_tm_t_m ), 1 => array( 'time_from_h' => empty( $contact_time_2_f_h ) ? ''
                        : $contact_time_2_f_h, 'time_from_m' => empty( $contact_time_2_f_m ) ? ''
                        : $contact_time_2_f_m, 'time_to_h' => empty( $contact_time_2_t_h ) ? ''
                        : $contact_time_2_t_h, 'time_to_m' => empty( $contact_time_2_t_m ) ? ''
                        : $contact_time_2_t_m, 'time_tm_from_h' => empty( $contact_time_2_tm_f_h ) ? ''
                        : $contact_time_2_tm_f_h, 'time_tm_from_m' => empty( $contact_time_2_tm_f_m ) ? ''
            ...
            case "add_user":
                ...
                $data_user = array( 'user_login' => $this->input->xss_clean( $login ), 'user_password' => $this->input->xss_clean( $password ), 'first_name' => $this->input->xss_clean( $firstname ), 'last_name' => $this->input->xss_clean( $lastname ), 'user_email' => $this->input->xss_clean( $user_email ), 'user_role' => $this->input->xss_clean( $user_role ), 'registration_date' => date( "Y-m-d" ), 'user_role' => $user_role );
            ...
            case "update_user":
                ...
                $data_user = array( 'user_login' => $this->input->xss_clean( $login ), 'first_name' => $this->input->xss_clean( $firstname ), 'last_name' => $this->input->xss_clean( $lastname ), 'user_email' => $this->input->xss_clean( $user_email ), 'user_role' => $this->input->xss_clean( $user_role ), 'registration_date' => date( "Y-m-d" ), 'user_role' => $user_role );
            ...
            case "add_currency":
                ...
                if ( !empty( $currency_value ) )
                {
                    ...
                    if ( $currency )
                    {
                        ...
                        $data = array( "currency_id" => $currency->currency_id, "currency_value" => $currency->currency_value );
                        $data = json_encode( $data );
                    }
                }
            ...
            case "add_gallery":
                ...
                $data = (Object)array( "gallery_id" => $gallery_id, "gallery_info" => $gallery_info, "gallery_images" => $gallery_images );
                $data = json_encode( $data );
    ...
    function _item_page( $item_type, $item_id )
    {
        ...
        //			$val['gallery'] = $this->gallery->get_gallery($item->item_id, true);
