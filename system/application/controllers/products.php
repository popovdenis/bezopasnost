...
class Products extends Controller
{
    ...
    function subcat()
    {
        ...
        ob_start();
        $this->category->ShowTree( $main[0]->category_id, $category_id, $this->slug, $main[0]->category_id, $partners_cat );
...
//            $header_links = $this->get_head_links( $category_id );

            $data['paginate_args'] = array( 'total_rows' => $items_block['items_count'], 'per_page' => $this->per_page, 'num_links' => $this->num_links, 'cur_page' => $this->cur_page, 'uri_segment' => $this->uri_segment, 'base_url' => base_url() . 'information/page/' );
