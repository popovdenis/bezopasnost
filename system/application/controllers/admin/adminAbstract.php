...
abstract class AdminAbstract extends Controller
{
    ...
    public function doUpload()
    {
        ...
        $item_data = [
            ...
            'attach_type'       => $upload_data['file_type'],
            'attach_img_width'  => 0,
            'attach_img_height' => 0,
            'attach_ext'        => $upload_data['file_ext'],
            'attach_size'       => $upload_data['file_size'],
        ...
        $fullPath = base_url() . '/' . $item_data['attach_path'];
        $message = 'Файл ' . $newFileName . ' загружен';
